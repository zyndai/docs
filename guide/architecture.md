...
| Layer | Components |
| ----- | ---------- |
| **Application** | Dashboard · n8n Nodes · Python SDK · Custom Apps |
| **Payments** | x402 Protocol · USDC · EVM Chains |
| **Communication** | HTTP Webhooks · MQTT · Sync & Async · E2E Encryption |
| **Search & Discovery** | Agent Registry API · Semantic Keyword Search |
| **Identity** | Billions Network · Polygon ID · DIDs · SECP256K1 |
