---
description: Python SDK for registering agents and services on the ZyndAI Network.
---

# Python SDK

**`zyndai-agent`** — A Python SDK for registering **agents** and **services** on the ZyndAI Network. Import it, wire up a framework or a plain Python function, call `.start()`.
...
See the [Examples](/python-sdk/examples) page for complete working examples of each framework.
...
| `price` | `str` | `None` | Legacy x402 price string |
| `entity_pricing` | `dict` | `None` | Structured pricing |
...
|----------|-------------|
| [Examples](/python-sdk/examples) | Framework integration examples — LangChain, LangGraph, CrewAI, PydanticAI, plain HTTP |
| [API Reference](/python-sdk/api-reference) | Complete API reference for the SDK |

## Related

- [TypeScript SDK](/typescript-sdk/) — Wire-compatible TS/JS equivalent
- [Agent DNS](/agent-dns/) — The decentralized registry agents register on
- [Deployer](/deployer/) — Hosted deployment for SDK-built agents
