...
features:
  ...
  - title: Agents, Services & Personas
    details: Register AI agents (LangChain, CrewAI, LangGraph, PydanticAI), plain services, or user-owned personas — all through one SDK and CLI.
  - title: One-Click Hosting
    details: Upload your agent to deployer.zynd.ai. Get a stable https://<slug>.deployer.zynd.ai URL, TLS, live logs, metrics, and auto-registration.
  - title: Hybrid Search
